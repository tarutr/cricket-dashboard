...
const BATTING_METRICS = [
  ...
  },
  {
    ...
    shortLabel: "Bat SR",
    columnTitle: "Batting Strike Rate",
    discipline: "batting",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "BpD",
    columnTitle: "Balls per Dismissal",
    discipline: "batting",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "BpB",
    columnTitle: "Balls per Boundary",
    discipline: "batting",
    source: "innings",
  ...
  // "—" and is dropped from that ranking (§8.1).
  {
    ...
    shortLabel: "SR 1-10",
    columnTitle: "Strike Rate (first 10 balls)",
    discipline: "batting",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "SR 11-20",
    columnTitle: "Strike Rate (balls 11–20)",
    discipline: "batting",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "SR 21+",
    columnTitle: "Strike Rate (21+ balls)",
    discipline: "batting",
    source: "innings",
  ...
  // Phase strike rates — T20 ranges (pp 0–5, mid 6–14, death 15–19).
  {
    ...
    shortLabel: "PP SR",
    columnTitle: "Powerplay Strike Rate",
    discipline: "batting",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "Mid SR",
    columnTitle: "Middle Overs Strike Rate",
    discipline: "batting",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "Death SR",
    columnTitle: "Death Overs Strike Rate",
    discipline: "batting",
    source: "innings",
  ...
  // Phase strike rates — ODI ranges (pp 0–9, mid 10–39, death 40–49).
  {
    ...
    columnTitle: "ODI Powerplay Strike Rate",
    discipline: "batting",
    source: "innings",
  ...
  },
  {
    ...
    columnTitle: "ODI Middle Overs Strike Rate",
    discipline: "batting",
    source: "innings",
  ...
  },
  {
    ...
    columnTitle: "ODI Death Overs Strike Rate",
    discipline: "batting",
    source: "innings",
  ...
  // is_not_boundary rule, so they ARE the boundary balls).
  {
    ...
    shortLabel: "NBSR",
    columnTitle: "Non-Boundary Strike Rate",
    discipline: "batting",
    source: "innings",
    sqlExpression:
  ...
  // Descriptive style split, so higherIsBetter null, matching every % Runs sibling.
  {
    ...
    shortLabel: "4s-bdry%",
    columnTitle: "% Runs in 4s (boundary)",
    discipline: "batting",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "6s-bdry%",
    columnTitle: "% Runs in 6s (boundary)",
    discipline: "batting",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "BF%",
    columnTitle: "Percentage of Balls Faced",
    discipline: "batting",
    source: "innings",
...
for (const d of DISMISSAL_KINDS) {
  ...
  BATTING_METRICS.push({
    ...
    label: d.label,
    shortLabel: d.short,
    // decision 81C: full-name hover tooltip for the abbreviated shortLabel.
    columnTitle: d.label,
    discipline: "batting",
    source: "innings",
    section: "dismissal",
...
const BOWLING_METRICS = [
  ...
  },
  {
    ...
    shortLabel: "Bowl SR",
    columnTitle: "Bowling Strike Rate",
    discipline: "bowling",
    source: "innings",
  ...
  // a genuine collision the owner flagged. Number/sqlExpression unchanged.
  {
    ...
    columnTitle: "Boundary Run % Conceded",
    discipline: "bowling",
    source: "innings",
  ...
  // NULLIF-guarded (0 runs conceded → NULL, never Infinity).
  {
    ...
    shortLabel: "4s Con%",
    columnTitle: "% Runs Conceded in 4s",
    discipline: "bowling",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "6s Con%",
    columnTitle: "% Runs Conceded in 6s",
    discipline: "bowling",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "NB Runs Con. %",
    columnTitle: "% Runs Conceded in Non-Boundary",
    discipline: "bowling",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "Wd Con%",
    columnTitle: "% Runs Conceded in Wides",
    discipline: "bowling",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "Nb Con%",
    columnTitle: "% Runs Conceded in No-balls",
    discipline: "bowling",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "WPI",
    columnTitle: "Wickets per Innings",
    discipline: "bowling",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "Mid Econ",
    columnTitle: "Middle Overs Economy",
    discipline: "bowling",
    source: "innings",
  ...
  },
  {
    ...
    columnTitle: "Death Overs Economy",
    discipline: "bowling",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "Mid Wkts",
    columnTitle: "Middle Overs Wickets",
    discipline: "bowling",
    source: "innings",
  ...
  },
  {
    ...
    columnTitle: "Death Overs Wickets",
    discipline: "bowling",
    source: "innings",
  ...
  // Phase economy + wickets — ODI ranges.
  {
    ...
    columnTitle: "ODI Powerplay Economy",
    discipline: "bowling",
    source: "innings",
  ...
  },
  {
    ...
    columnTitle: "ODI Middle Overs Economy",
    discipline: "bowling",
    source: "innings",
  ...
  },
  {
    ...
    columnTitle: "ODI Death Overs Economy",
    discipline: "bowling",
    source: "innings",
  ...
  },
  {
    ...
    columnTitle: "ODI Powerplay Wickets",
    discipline: "bowling",
    source: "innings",
  ...
  },
  {
    ...
    columnTitle: "ODI Middle Overs Wickets",
    discipline: "bowling",
    source: "innings",
  ...
  },
  {
    ...
    columnTitle: "ODI Death Overs Wickets",
    discipline: "bowling",
    source: "innings",
  ...
  },
  {
    ...
    shortLabel: "Dots Con",
    columnTitle: "Dot Balls Conceded",
    discipline: "bowling",
    source: "innings",
    sqlExpression: "SUM(dots)",
...
const MATCHUP_BOWLING_METRICS = [
  ...
  },
  {
    ...
    shortLabel: "BBI",
    columnTitle: "Best Bowling (Innings)",
    discipline: "matchup_bowling",
    source: "matchup",
...
export function getMetric(key, discipline) {
  if (discipline) {
    ...
    return (
      ...
      // New standalone OPPOSITION composer (2026-08-14): opp__<hex>__<base> conditional
      ...
      // New standalone EVENT composer (Step 4, 2026-08-14): event__<hex>__<base>
      // conditional aggregation over the joined mctx.event_name (canonical→raw via
      // eventAliases; both disciplines). null for any other prefix / non-plain
      // discipline. Needs the mctx join present (table.js event gate).
      resolveComposedEventMetric(key, discipline) ??
      // New standalone VENUE composer (Step 4, 2026-08-14): venue__<hex>__<base>
      // conditional aggregation over the joined mctx.venue (RAW equality, no fold;
      // both disciplines). null for any other prefix / non-plain discipline. Needs
      // the mctx join present (table.js venue gate).
      resolveComposedVenueMetric(key, discipline) ??
      // City & Season everywhere (2026-08-16): city__/season__ composers (RAW equality
      // over mctx.city / mctx.season, both disciplines) + the City/Season "which values"
      // list columns (city_set / season_set). null for any other key. All need the mctx
      // join present (table.js city/season gate).
      resolveComposedCityMetric(key, discipline) ??
...
function buildComposedPhaseMetric(phaseToken, baseKey, discipline) {
  ...
  return {
    ...
    // decision 81C: full-name hover tooltip for the abbreviated composed shortLabel.
    columnTitle: `${COMPOSED_PHASE_LABEL[phaseToken]} ${base.label}`,
...
function buildComposedBallMetric(bucketToken, baseKey, discipline) {
  ...
  return {
    ...
    // decision 81C: full-name hover tooltip for the abbreviated composed shortLabel.
    columnTitle: `${COMPOSED_BALL_LABEL[bucketToken]} ${base.label}`,
  };
}
...
function buildComposedInningsMetric(inningsToken, baseKey, discipline) {
  ...
  return {
    ...
    // decision 81C: full-name hover tooltip for the abbreviated composed shortLabel.
    columnTitle: `${COMPOSED_INNINGS_LABEL[inningsToken]} ${base.label}`,
  };
}
...
export function citySetColumnKeys(discipline) {
  return discipline === "batting" || discipline === "bowling" ? [CITY_SET_KEY] : [];
}

/** Resolve the Season which-values key to its VIRTUAL list metric (both disciplines),
...
// The string<->hex key codec EVERY composer family shares (moved here from the
// Team block by the item-B cleanup, byte-for-byte unchanged). Generic: no team-
// specific logic despite the historical names.
...
function makeComposerFamily(spec) {
  ...
  function buildMetric(name, baseKey, discipline) {
    ...
    const composedLabel = labelFor(base.label, displayName);
    return {
      ...base,
      ...
      // decision 81C: full-name hover tooltip for the (possibly abbreviated)
      // composed shortLabel — the composed label itself, display-only.
      columnTitle: composedLabel,
    };
  }
...
// ── Composed TEAM × metric columns (standalone composer, 2026-08-14; factory-built
...
// a base stat → one column per picked team, e.g. "Bat Avg (India)". Conditional
// aggregation over a raw per-row column, like the Batting-Position composer (pos__),
// with ONE difference: the value is an arbitrary TEAM NAME string, not a fixed
// p1..p12 token.
//
// TWO things set Team (and its Opposition mirror) apart from the five match-context
// families:
//  1. The conditional column is DISCIPLINE-DEPENDENT — the player's OWN side, via
//     SCOPE_TEAM_COL: `batting_team` on the batting view, `bowling_team` on the
//     bowling view. Hence `colFor` reads the map per discipline instead of returning
//     a constant, and the family's gate is that same map's truthiness (SCOPE_TEAM_COL
//     has exactly the two plain keys, so the gate and the column agree by
//     construction).
//  2. NO mctx JOIN. Both columns are already projected on the base views — no match-
//     context sub-select, NO query change, and NOTHING for table.js's join gates to
//     light (those key off isComposedStage/Event/Venue/City/Season only; there is
//     deliberately no isComposedTeam gate there). A composed Team metric must
//     therefore never reference `mctx.` — the factory guarantees that by substituting
//     exactly the column `colFor` returns.
//
// The base-metric POOL, the component SET, the per-metric SPECS (COMPOSED_INNINGS_*),
// the string↔hex key codec and the `''` escape are all SHARED via makeComposerFamily
// above — which is where the former `buildComposedTeamMetric` body now lives — so a
// base rate's formula / NULLIF guard / component `needs` can NEVER drift between
// composers (Rule 1).
//
// KEY = `team__<hexToken>__<baseKey>`  e.g. `team__496e646961__average` (India).
// The value is HEX of the team name's UTF-8 bytes: identifier-safe ([0-9a-f]*, so the
// KEY is a valid UNQUOTED SQL alias — table.js emits `… AS ${m.key}`), separator-free
// (no `__`, so the first `__` after the prefix cleanly splits token|baseKey; base keys
// carry only single underscores), and it ROUND-TRIPS any string (spaces / punctuation
// / apostrophes / unicode) with no lookup table. No catalogued key and no other
// composed prefix starts with `team__` (the which-values `team_set` is a single
// underscore — "team_set".startsWith("team__") is false).
//
// The six exports are the SAME six functions, same names, same signatures, same
// return shapes as before the factory:
//   makeComposedTeamKey(teamName, baseKey) → key
//   parseComposedTeamKey(key)              → { token, teamName, baseKey } | null
//   resolveComposedTeamMetric(key, disc)   → the virtual metric | null (getMetric)
//   composedTeamPool(disc)                 → the ordered base metrics offered
//   registerComposedTeamKeys(keys)         → record minted key(s)
//   eligibleComposedTeamKeys(disc)         → registered keys that still resolve
//     (the session registry state.js:1362 refers to as metrics._composedTeamKeys is
//     now the factory's private per-family Set)
export const {
  makeKey: makeComposedTeamKey,
  parseKey: parseComposedTeamKey,
  resolveMetric: resolveComposedTeamMetric,
  pool: composedTeamPool,
  register: registerComposedTeamKeys,
  eligible: eligibleComposedTeamKeys,
} = makeComposerFamily({
  prefix: "team__",
  flag: "isComposedTeam",
  nameField: "teamName",
  gate: (discipline) => !!SCOPE_TEAM_COL[discipline],
  colFor: (discipline) => SCOPE_TEAM_COL[discipline],
  mechanic: "equality",
...
//    factory-built since the item-B cleanup, 2026-08-24) ───────────────────────
// The EVENT composer — standalone and filter-independent like every other (reads/
// writes NOTHING on state.event). Pick value(s) [CANONICAL event names] × a base stat
// → one column per picked event, e.g. "Bat Avg (ICC Men's T20 World Cup)". Shares the
// pool / component set / SPECS / hex codec / `''` escape via makeComposerFamily above,
// which is also where the former `buildComposedEventMetric` body went.
//
// This is one of the TWO families that differ from the five raw-equality ones, and
// both differences matter:
//
//  1. **mechanic "membership" — the WHOLE-TEST replace.** A canonical event name maps
//     to MULTIPLE raw `event_name` spellings (sponsor renames, rebrands), so the
//     conditional is NOT `mctx.event_name = '<value>'` but
//     `mctx.event_name IN (<raw spellings>)`. The factory therefore replaces the
//     entire literal substring `innings_number = {S}` (present in EVERY spec) with the
//     test `membershipFor` returns — a bare `{S}` swap would wrongly leave `= '<value>'`
//     and the column would count only the one spelling that happens to match the
//     canonical label. The expansion is `eventAliases` (canonicalNames.js), the EXACT
//     helper filters.js eventPredicateSql calls, so a composed Event column and the
//     Event FILTER always agree; it is never re-derived here. Defensive: an empty
//     expansion yields no column (eventAliases always returns >= 1).
//
//  2. **The mctx JOIN is REQUIRED.** `event_name` lives on `matches`, not on the base
//     views, and is read off the shared 1:1 LEFT JOIN as `mctx.event_name`. table.js
//     lights that join for the leaderboard by scanning the chosen columns for
//     `isComposedEvent` (table.js:1918, alongside the `event_set` key) — so the flag
//     name below is LOAD-BEARING, not decorative: a generic flag would emit SQL
//     referencing an unjoined alias, i.e. a FAILED query rather than a wrong number.
//     Unlike Team/Opposition, every generated Event expression MUST contain `mctx.`.
//
// KEY = `event__<hexToken>__<baseKey>` e.g. `event__57...__average`. Double
// underscore, so no single-underscore key ("event_set") can ever collide.
//
// The six exports are the SAME six functions, same names, same signatures, same
// return shapes as before the factory:
//   makeComposedEventKey(eventName, baseKey) → key
//   parseComposedEventKey(key)               → { token, eventName, baseKey } | null
//   resolveComposedEventMetric(key, disc)    → the virtual metric | null (getMetric)
//   composedEventPool(disc)                  → the ordered base metrics offered
//   registerComposedEventKeys(keys)          → record minted key(s)
//   eligibleComposedEventKeys(disc)          → registered keys that still resolve
export const {
  makeKey: makeComposedEventKey,
  parseKey: parseComposedEventKey,
  resolveMetric: resolveComposedEventMetric,
  pool: composedEventPool,
  register: registerComposedEventKeys,
  eligible: eligibleComposedEventKeys,
} = makeComposerFamily({
  prefix: "event__",
  flag: "isComposedEvent",
  nameField: "eventName",
  gate: (discipline) => discipline === "batting" || discipline === "bowling",
  colFor: () => "mctx.event_name",
  mechanic: "membership",
  // Canonical -> raw expansion, IDENTICAL to the Event FILTER (filters.js
  // eventPredicateSql -> eventAliases). Each raw becomes a SQL string literal with its
  // single quotes doubled, via the escape every family shares.
  membershipFor: (eventName, col) => {
    const raws = eventAliases(eventName);
    if (!Array.isArray(raws) || raws.length === 0) return null;
    return { test: `${col} IN (${raws.map(composerSqlLiteral).join(", ")})`, displayName: eventName };
  },
  labelFor: (text, eventName) => `${text} (${eventName})`,
});
...
const COMPOSED_RUNSOURCE_CONC_DIMS = [
  ...
  { token: "nonbdry", rowLabel: "Non-Boundary", num: "SUM(runs_conceded) - SUM(wides_runs) - SUM(noball_runs) - 4 * SUM(fours_conceded) - 6 * SUM(sixes_conceded)", countLabel: "Runs Conceded in Non-Boundary", countShort: "NB Con Runs", pctLabel: "% Runs Conceded in Non-Boundary", pctShort: "NB Runs Con. %" },
  ...
  if (discipline === "batting") {
    ...
    if (axis === "count") {
      return {
        ...
        // decision 81C: full-name hover tooltip for the shortLabel.
        columnTitle: spec.label,
        discipline: "batting", source: "innings",
